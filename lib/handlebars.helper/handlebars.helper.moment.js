(function(moduleFactory) {
    if(typeof exports === "object") {
        module.exports = moduleFactory(require("lodash"), require("moment"), require("handlebars"));
    } else if(typeof define === "function" && define.amd) {
        define(["underscore", "moment", 'handlebars'], moduleFactory);
    }
}(function(_, moment, Handlebars) {

    var MomentHelpers = function() {
        var momentFormatMap = {
